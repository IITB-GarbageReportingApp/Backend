...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-x+ka=tn86wq*^y(p0a^r4ug(x3n#1!d4f=$$6mpemb%%hw=drn')
...
# Database - Keep SQLite for now, but consider PostgreSQL for production
DATABASES = {
    'default': {
...
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='iitbcleanandgreen@gmail.com')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='zctfoulsnwruybod')
