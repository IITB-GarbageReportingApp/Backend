...
# Make sure Django can find static files for fallback images
STATIC_URL = '/static/'
...
EMAIL_USE_TLS = True
# EMAIL_USE_SSL = False
EMAIL_HOST_USER = 'iitbcleanandgreen@gmail.com'  # Replace with your Gmail
# EMAIL_HOST_PASSWORD = 'suqmorbxlufjgtur'  # Replace with your app password
EMAIL_HOST_PASSWORD = 'zctfoulsnwruybod'
